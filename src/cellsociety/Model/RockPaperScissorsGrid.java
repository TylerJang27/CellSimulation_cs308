...
public class RockPaperScissorsGrid extends Grid {
  ...
  private static final int MAX_VAL = SimType.of(RESOURCES.getString("RockPaperScissors"))
      .getMaxVal();
  ;
   ...
   */
  private void parametrizedRandomGenerator(Map<String, Integer> cellValues, int threshold,
      Point p) {
