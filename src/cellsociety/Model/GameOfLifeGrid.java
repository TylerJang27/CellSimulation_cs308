...
public class GameOfLifeGrid extends Grid {
  ...
  /**
   * Uses gridMap to construct GameOfLife and gridcell values to set cells at points based on shape
   * of cells.
   *
  ...
  private void parametrizedRandomGenerator(Map<String, Integer> cellValues, Point p) {
    double coverage =
        cellValues.getOrDefault(RESOURCES.getString("Coverage"), COVERAGE_DEFAULT) / 100.0;
