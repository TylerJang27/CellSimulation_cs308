...
public class CellView extends Pane {
  ...
  /**
   * Construct a CellView with the given List of configurations. the index of each configuration in
   * the list will be mirrored in the List of CellStates created
   *
  ...
  private void addCellState(CellStateConfiguration currentConfiguration) {
    Shape cellTemplate = createShape(currentConfiguration.getShape(),
