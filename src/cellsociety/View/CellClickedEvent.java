...
/**
 * A class that wraps a MouseEvent, but with additional instance variables that specify which Cell
 * the Mouse clicked. This allows for all Cells to be attached to the same EventHandler, which will
 * delegate tasks accordingly with respect to the row and column of the cell clicked
 *
